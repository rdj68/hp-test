...
selectClass.append(`<option>${"Alumni"}</option>`);
...
function onClickLogin() {
  ...
  const isSelectedStateDefault =
    selectedState.attr("data-default") !== undefined;
  const isSelectedDistrictDefault =
    selectedDistrict.attr("data-default") !== undefined;
  const isSelectedClassDefault =
    selectedDistrict.attr("data-default") !== undefined;
